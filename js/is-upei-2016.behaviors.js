(function ($) {
	 ...
	 */
	Drupal.theme.prototype.isUpei2016ExampleButton = function (path, title) {
	...
	Drupal.behaviors.isUpei2016ExampleBehavior = {
		attach: function (context, settings) {
			...
			$('.some-selector', context).once('foo', function () {
				...
				var $anchor = Drupal.theme('isUpei2016ExampleButton', settings.myExampleLinkPath, settings.myExampleLinkTitle);
